...
function handleClick(clickedButtonEvent) {
    ...
    const card = {
        ...
        img: cardNode.getElementsByTagName('img')[0], // здесь картинка внутри .product
        productName: cardNode.getElementsByClassName('productName')[0], // здесь .productName, который внутри .product
        button: cardNode.getElementsByTagName('button')[0], // здесь button, который внутри .product
    };
...
function hideMoreText(card) {
    ...
    document.getElementsByClassName('desc')[0].remove();
...
function showMoreText(card) {
    ...
    const randomText = 'Lorem ipsum dolor sit, amet consectetur, adipisicing elit. Excepturi, hic.';
